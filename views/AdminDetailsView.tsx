  ...
  return (
    <div className="content grid grid-cols-2 gap-4 border p-4">
      <div className="payer-details border p-4">
        ...
        <h6>Country: {filterCountries(order.payer.address.country_code)}</h6>
      </div>
      <div className="payer-details border p-4">
      ...
      <div className="payer-details border p-4">
        ...
        <h6>City: {order.purchase_units[0].shipping.address.admin_area_2}</h6>
        <h6>State: {order.purchase_units[0].shipping.address.admin_area_1}</h6>
        <h6>
          Country:{" "}
          {filterCountries(
      ...
      <div className="payer-details border p-4">
        ...
        <h6>
          Payment Status: {order.status === "COMPLETED" ? "PAID" : "NOT PAID"}
        </h6>
        <h6>
          Amount Paid: $
